...
<div id="mySidenav" class="sidenav bg-dark">
  ...
  <hr/>
  <br/>
  <h5 class="text-capitalize text-bold lead px-1">Howdy, '.$row[1].'</h5>
<img src='."profilePic/".@$user_info_row["profile_picture"]. ' class=" rounded-circle m-4" id="profilePic" height="40" width="40">
<br/>
...
<ul class="nav nav-tabs d-flex align-items-center justify-content-around bg-primary big_screen_nav d-sm-none d-md-flex">
  ...
  <li class="nav-item big_screen">
    <a class="nav-link text-capitalize text-light find-users" id="findUsers" href="#">Find Users</a>
  </li>
    <li class="nav-item big_screen">
    <a class="nav-link text-capitalize text-light message-users" id="messageUsers" href="#">Message Users</a>
  </li>
    ...
    <li class="nav-item big_screen">
    <a class="nav-link text-capitalize text-light change-profile" id="changeProfile" href="#">Update Profile</a>
  </li>
