...
<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" id="signUp" method="POST"  class="m-auto w-100 p-4 form rounded shadow bg-dark text-light" autocomplete="off">
