...
<?php require_once "nav.php";?>
    ...
    <h3 class="text-capitalize text-center">user profile picture</h3>
       ...
       <br/>
       <br/>
    <button class="btn btn-primary"><a href='<?php echo "viewUsersProfile.php?ID=$profile_id"?>' class="text-decoration-none text-center text-light text-capitalize my-3 p-2">&lt;&lt; go back</a></button>
    </div>
</body>
</html>