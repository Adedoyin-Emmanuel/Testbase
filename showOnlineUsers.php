...
<script>
    ...
    $(document).ready(($)=>{
       ...
       setInterval(()=>{
            ...
            xhttp.open("GET","showOnlineUsersList.php",true);
            xhttp.send();
...
<div class="container-fluid m-auto d-flex align-items-center justify-content-around flex-column form">
