...
<br/><br/>
    <input type="submit" value="Search User" class="btn btn-primary   form-control text-center" name="users_search">
...
<br/>
    <input type="submit" value="Search User" class="btn btn-primary form-control text-center" name="submit_direct_query">
    <br/>
         ...
         #check if something went wrong with the connection
            ...
            if(!$get_users_result){
                ...
                while($user_search_row=mysqli_fetch_assoc($get_users_result)){
                    ...
                    <a href="messageUser.php?receiver_id='.htmlspecialchars($user_search_row["U_ID"]).'"title="View '.$user_search_row["user_name"].' Profile" class="d-block text-decoration-none" autofocus style="border:none; outline:none; ::selection{border:none; outline:none;}">
                    <div class=" container" >
